kalman_filter <- function(pp = 1, hh = 1, prior_constant_variance = 10,
...
model <- model_initialize(yraw, pp, hh, prior_constant_variance, gg, kk, ll)
...
# # build model_probability_predict and model_probability_update
